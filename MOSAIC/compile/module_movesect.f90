	...
	use module_data_mosaic_main, only:  mw_air, ntot_used, pi, species
...
!-----------------------------------------------------------------------
	subroutine move_sections_x3( iphase_flag, iclm, jclm, k, m, rbox,   &
          fact_apmassmr, fact_apnumbmr, fact_apdens, fact_apdiam,   &
      	  ...
      	  adryqmas_tmp,it_mosaic,mmovesect_flag1 )
!
...
!   subr arguments
	integer, intent(in) :: iphase_flag, iclm, jclm, k, m, it_mosaic,mmovesect_flag1
...
!-----------------------------------------------------------------------
	subroutine test_move_sections( iphase_flag_inp, iclm, jclm, k, m,it_mosaic,mmovesect_flag1)
!
...
!   subr arguments
	integer, intent(in) :: iphase_flag_inp, iclm, jclm, k, m,it_mosaic,mmovesect_flag1
