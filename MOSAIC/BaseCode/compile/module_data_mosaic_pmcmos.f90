...
! (water vapor molec wght)/(air molec wght)
      ...
      integer,  save :: pmcmos_inputfile_version  ! 1="older" ; 2=partmc-2.2.0 and later !BSINGH - 05/28/2013(RCE updates)
...
! prescribed aerosol emissions versus time
      ...
      real(r8), allocatable, save :: aer_emit_fac(:)   ! adjustment factor (---)!BSINGH - 05/28/2013(RCE updates)
      type( aer_dist_t ), allocatable, save :: &
                                     aer_emit_dist(:)  ! aer distribution (***)
      real(r8), allocatable, save :: aer_emit_cnn(:,:) ! 
      
      real(r8), save :: aer_emit_adjust_fac   ! additional adjustment factor (---)!BSINGH - 05/28/2013(RCE updates)
! initial aerosol
...
! names of pmcmos input files
      ...
      character(len=512), save :: pmcmos_inputfile_directory!BSINGH - 05/28/2013(RCE updates)
