...
! SORGAM
      ...
      p_urb(iaro1)= yield_factor*0.039*(r_urb(18)+r_urb(19)+r_urb(21)+r_urb(22))
      d_urb(iaro1)= 0.0

      p_urb(iaro2)= yield_factor*0.0108*(r_urb(18)+r_urb(19)+r_urb(21)+r_urb(22))
      d_urb(iaro2)= 0.0
...
! 25% of PAR is assumed to be associated with C > 8 carbon atoms, which produces SOA
      ...
      p_urb(iole1)= yield_factor*0.008*(r_urb(12)+r_urb(13)+r_urb(14)+r_urb(15)+   &
                          r_urb(16)+r_urb(17))
      d_urb(iole1)= 0.0
